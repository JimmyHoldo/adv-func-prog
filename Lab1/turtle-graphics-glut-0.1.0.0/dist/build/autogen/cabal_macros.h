...
/* package turtle-graphics-glut-0.1.0.0 */
#define VERSION_turtle_graphics_glut "0.1.0.0"
#define MIN_VERSION_turtle_graphics_glut(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "turtle-graphics-glut-0.1.0.0-D5NI6NixMABJpzNheZNIeM"

#define CURRENT_PACKAGE_KEY "turtle-graphics-glut-0.1.0.0-D5NI6NixMABJpzNheZNIeM"
